...
lives in the domain package"; across all 57 rows there is no `.md` row, while this document alone
...
the narrower wording **32 of these 57 rows fall out of scope**. The acceptance is the stricter and
